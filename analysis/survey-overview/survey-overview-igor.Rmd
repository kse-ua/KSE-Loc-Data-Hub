...
```{r help-military-number, fig.height=5, fig.width=9,class.source="fold-hide", eval = TRUE}
...
```{r help-idp, fig.height=5, fig.width=9,class.source="fold-hide", eval = TRUE}
...
```{r special-fund-no-combat, fig.height=3, fig.width=9,class.source="fold-hide", eval=TRUE}
...
```{r special-fund-urbanisation, fig.height=3, fig.width=9,class.source="fold-hide", eval=TRUE}
(ds0 %>% filter(military_action=="no_combat") %>%
  mutate(
    `Special fund's expenditures were relocated` = case_when(special_fund_relocation=="no"~0,
                                                             special_fund_relocation=="yes"~1)
...
```{r problem-models, results = "asis", class.source="fold-hide"}
