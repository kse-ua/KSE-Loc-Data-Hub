...
read_chunk("./analysis/survey-overview/survey-overview-serhii.R") #This allows knitr to call chunks tagged in the underlying *.R file.
...
```{r dftg-military-help, fig.height=3, fig.width=9,class.source="fold-hide"}
d <- ds0 %>%
...
```{r special-fund-2, fig.height=3, fig.width=9,class.source="fold-hide"}
ds0 %>% 
...
```{r relocation-1, fig.height=3, fig.width=9, class.source="fold-hide"}
ds0 %>% 
...
```{r jobs-1, fig.height=3, fig.width=9,class.source="fold-hide"}
(ds0 %>% 
   mutate(
...
```{r bussiness-stimeles-1, fig.height=3, fig.width=9,class.source="fold-hide"}
...
m1_heating <-lm(data = ds1_winter_prep, 
       winter_prep_count ~ log(income_total_2021) + income_own_pct + 
...
m1_problem <-glm(data = ds1_problem, 
             hromada_exp ~ log(income_total_2021) + income_own_pct + 
             type + square + log(total_population_2022) + urban_pct + n_settlements + region_en + occupation + military_action + voluntary,
             family = "binomial")
...
```{r problem-1, fig.height=3, fig.width=9, class.source="fold-hide"}
