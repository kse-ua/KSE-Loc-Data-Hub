...
```{r help-idp-voluntary, fig.height=5, fig.width=9, class.source="hide", eval = TRUE}
...
> The quality of answers for question about missed school days(including virtual learning) since February 24th was poor. However, 
...
ds1_winter_prep %>% 
  ...
  labs(
    ...
    ,y = "Share of hromadas", x = "Number of measures", fill = NULL
  ) +
  xlab("winter_prep_count")
```

```{r heating-models, results = "asis", class.source="fold-hide", eval = F}
...
```{r problem-models, results = "asis", class.source="fold-hide", eval = F}
